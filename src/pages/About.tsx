    ...
    <div className="bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 prose max-w-none">
          <p>
            Welcome to Free Insect Identifier, your educational resource for AI-powered insect identification.
            We're passionate about helping people learn about the fascinating world of insects through
            technology, while promoting understanding and appreciation of these important creatures.
          </p>

          <h2>Our Mission</h2>
          <p>
            Our mission is to make insect education accessible to everyone by providing a free, easy-to-use
          ...
          <ul>
            <li>Advanced AI insect recognition technology</li>
            <li>Detailed species information</li>
            <li>Educational insights about insects</li>
            <li>Habitat and behavior details</li>
            <li>Life cycle information</li>
          ...
          <p>
            We're committed to keeping this insect identification tool free and accessible to everyone.
            ...
            nature enthusiasts who want to learn about the incredible world of insects.
          </p>

          <div className="mt-8 text-center">
            <a
              href="https://roihacks.gumroad.com/l/dselxe?utm_campaign=donation-home-page&utm_medium=website&utm_source=insect-identifier"
              target="_blank"
