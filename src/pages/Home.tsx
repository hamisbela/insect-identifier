...
// Default insect image path
const DEFAULT_IMAGE = "/default-insect.jpg";

// Default analysis for the insect
...
- Pattern: Orange wings with black veins and borders
- Body: Black body with white spots
- Distinctive Features: Bright orange coloration with black veining
- Antennae: Long, club-shaped

3. Habitat & Distribution:
- Environment: Gardens, meadows, fields
- Geographic Range: North America, migrates to Mexico
- Preferred Climate: Temperate to tropical
- Activity Pattern: Diurnal (active during day)
- Host Plants: Milkweed species

4. Educational Notes:
- Behavior: Famous for long-distance migration
- Diet: Nectar from flowers, caterpillars feed on milkweed
- Ecological Role: Important pollinator
- Conservation Status: Population declining
- Cultural Significance: Symbol of transformation

5. Additional Information:
- Life Cycle: Complete metamorphosis
- Lifespan: 2-6 weeks as adult
- Migration: Travels up to 3,000 miles
- Interesting Facts: Can detect milkweed from several miles away
- Ecological Impact: Indicator species for environmental health`;
...
export default function Home() {
  ...
  const handleAnalyze = async (imageData: string) => {
    setLoading(true);
    setError(null);
    const insectPrompt = "Analyze this insect image for educational purposes and provide the following information:\n1. Species identification (scientific name, common names, family)\n2. Physical characteristics (size, pattern, body features)\n3. Habitat & distribution\n4. Educational notes (behavior, diet, ecology)\n5. Additional information (life cycle, interesting facts)\n\nIMPORTANT: This is for educational purposes only.";
    try {
      const result = await analyzeImage(imageData, insectPrompt);
      setAnalysis(result);
    } catch (err) {
    ...
    <div className="bg-gray-50 py-6 sm:py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Free Insect Identifier</h1>
          <p className="text-base sm:text-lg text-gray-600">Upload an insect photo for educational identification and fascinating information</p>
        </div>
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-12">
          ...
          {analysis && (
            <div className="bg-gray-50 rounded-lg p-6 sm:p-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Insect Analysis Results</h2>
        ...
        <div className="prose max-w-none my-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8">Free Insect Identifier: Your Educational Guide to the World of Insects</h2>
          
          <p>Welcome to our free insect identifier tool, powered by advanced artificial intelligence technology.
             This educational tool helps you learn about different insect species, their characteristics, and
             fascinating information about their roles in our ecosystem.</p>

          <h3>How Our Educational Insect Identifier Works</h3>
          <p>Our tool uses AI to analyze insect photos and provide educational information about species
             characteristics, habitat, and interesting facts. Simply upload a clear photo of an insect,
             and our AI will help you learn about it.</p>

          <h3>Key Features of Our Insect Identifier</h3>
          <ul>
            ...
            <li>Life cycle details</li>
            <li>100% free to use</li>
          </ul>

          <h3>Perfect For Learning About:</h3>
          <ul>
            <li>Insect species identification</li>
            <li>Insect ecology and behavior</li>
            <li>Pollinator species</li>
            <li>Beneficial insects</li>
            <li>Nature education</li>
          </ul>

          <p>Try our free insect identifier today and explore the fascinating world of these remarkable creatures!
             No registration required - just upload a photo and start learning about insects.</p>
        </div>
